...
<script>
    $(function () {
        $("#updateUserForm").form('load','${pageContext.request.contextPath}/me/queryOne?id=${param.id}');
    })
</script>
<div style="text-align: center;">
    <form id="updateUserForm" class="easyui-form" method="post" enctype="multipart/form-data">
